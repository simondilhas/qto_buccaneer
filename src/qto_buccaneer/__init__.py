...
from .visualization import visualize_ifc  # Noua funcție cu statistici
from .colab_viewer import visualize_ifc as visualize_ifc_legacy  # Funcția veche

__all__ = [
    'visualize_ifc',
    'visualize_ifc_legacy',
    'IfcLoader',
    'QtoCalculator'
]
