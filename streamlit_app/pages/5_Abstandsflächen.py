...
def display_distance_layouts(graph_path):
    """Display distance layouts for all storeys"""
    storey_files = get_storey_files(graph_path, 'distance')
    ...
    if storey_files:
        ...
        st.warning("No distance floor layouts found")
...
if 'selected_building' in st.session_state:
    ...
    display_distance_layouts(paths['graph'])
else:
